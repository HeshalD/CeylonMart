      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center py-6">
          ...
          <div className="hidden md:flex items-center space-x-3">
            {/* Cart Button - Hidden on Payment Success, Orders, and Inventory Management Pages */}
            {location.pathname !== '/payment-success' && location.pathname !== '/orders' && !location.pathname.includes('/dashboard/inventory') && !location.pathname.includes('/inventory') && (
              <button
