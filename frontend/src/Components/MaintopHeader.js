...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 shadow-xl bg-gradient-to-r from-emerald-600 to-teal-700">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="flex items-center justify-between py-6">
          {/* Logo and Brand */}
          <div className="flex items-center space-x-4">
            <div className="flex items-center justify-center w-16 h-16 p-1 bg-white/20 rounded-2xl">
              {/* CeylonMart Logo */}
              <img 
                src={CeylonMartLogo} 
                alt="CeylonMart Logo" 
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-white transition-colors duration-200 hover:text-emerald-100"
            >
