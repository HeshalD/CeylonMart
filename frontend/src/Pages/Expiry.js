      ...
      pdfContainer.innerHTML = `
        <div style="font-family: Arial, sans-serif;">
          <div style="text-align: center; margin-bottom: 20px; padding: 15px; background: linear-gradient(to right, #059669, #0d9488, #0891b2); color: white; border-radius: 8px;">
            ...
            <h2 style="font-size: 18px; margin-bottom: 8px; font-weight: 500;">Expiry Alerts Report</h2>
            <p style="font-size: 12px; margin-bottom: 0;">Generated on: ${new Date().toLocaleDateString()} ${new Date().toLocaleTimeString()}</p>
          </div>
          ...
          <div style="margin-top: 30px; text-align: center; padding: 8px; background-color: #f0f9ff; border-top: 1px solid #0891b2; color: #0891b2; font-weight: 500; font-size: 12px;">
            Generated by CeylonMart Inventory Management System
          </div>
        </div>
      `;
