          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-600">Company: {user.company_name || 'Not set'}</p>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Supplier Stats</h3>
                <div className="mt-2">
                  <p className="text-sm text-gray-600">Products Supplied: 0</p>
                  <p className="text-sm text-gray-600">Active Orders: 0</p>
