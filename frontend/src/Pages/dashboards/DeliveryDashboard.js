      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                ...
                <div className="mt-2">
                  ...
                  <p className="text-sm text-gray-600">Delivery Areas: {user.deliveryAreas?.length || 0}</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="px-4 py-5 sm:p-6">
                <h3 className="text-lg leading-6 font-medium text-gray-900">Delivery Stats</h3>
                <div className="mt-2">
                  <p className="text-sm text-gray-600">Pending Deliveries: 0</p>
                  <p className="text-sm text-gray-600">Completed Today: 0</p>
                  <p className="text-sm text-gray-600">Active Drivers: 0</p>
                </div>
              </div>
            </div>
          </div>
