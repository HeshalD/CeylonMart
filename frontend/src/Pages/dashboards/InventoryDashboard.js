            ...
            <div className="bg-white/70 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <div className="px-6 py-8">
                <div className="flex items-center space-x-3 mb-6">
                  ...
                  <h3 className="text-xl font-bold text-gray-900">Manager Information</h3>
                </div>
                <div className="space-y-3">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="text-sm font-medium text-gray-600">Managed Items:</span>
                    <span className="text-sm font-semibold text-gray-900">{user.managedItems?.length || 0}</span>
                  </div>
                </div>
              </div>
            </div>
