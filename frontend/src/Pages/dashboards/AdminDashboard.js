  ...
  const generatePDF = () => {
    try {
      ...
      const stats = [
        ...
        `Inventory Managers: ${users.filter(u => u.role === 'inventory_manager').length}`,
        `Delivery Managers: ${users.filter(u => u.role === 'delivery_admin').length}`,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-8">
            ...
            <div className="bg-white/70 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <div className="px-6 py-8">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Customers</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <div className="px-6 py-8">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Shop Owners</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <div className="px-6 py-8">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Suppliers</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <div className="px-6 py-8">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Inventory</h3>
            ...
            <div className="bg-white/70 backdrop-blur-sm overflow-hidden shadow-xl rounded-2xl border border-white/20 hover:shadow-2xl transition-all duration-300 hover:scale-105">
              <div className="px-6 py-8">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Delivery</h3>
          ...
          <div className="bg-white/70 backdrop-blur-sm shadow-xl overflow-hidden rounded-2xl border border-white/20">
            ...
            {loading ? (
              ...
              <div className="divide-y divide-gray-200/50">
                {filteredUsers.map((u) => (
                  <div key={u._id} className="px-6 py-6 hover:bg-gray-50/50 transition-colors duration-200">
                    {editingUser === u._id ? (
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-3">
                          <span className={`inline-flex px-3 py-1.5 text-sm font-semibold rounded-full ${
                            u.role === 'admin' ? 'bg-gradient-to-r from-red-100 to-red-200 text-red-800' :
                            u.role === 'shop_owner' ? 'bg-gradient-to-r from-blue-100 to-blue-200 text-blue-800' :
                            u.role === 'supplier_admin' ? 'bg-gradient-to-r from-purple-100 to-purple-200 text-purple-800' :
                            u.role === 'inventory_manager' ? 'bg-gradient-to-r from-amber-100 to-amber-200 text-amber-800' :
                            u.role === 'delivery_admin' ? 'bg-gradient-to-r from-pink-100 to-pink-200 text-pink-800' :
